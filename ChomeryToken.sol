...
contract ChomeryToken is ERC20Interface, SafeMath {
    string constant public name = "Chomery Token";
    string constant public symbol = "COMR";
    uint8 constant public decimals = 6;
    uint256 constant public _totalSupply = 1000000000000000;
